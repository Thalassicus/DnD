As the script loops through selected tokens, it marks each token with a yellow number corresponding to its place in the list of rolls. The "erase" macro clears these markers.
